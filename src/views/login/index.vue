  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="imageCode">
        ...
        <el-input :key="passwordType" ref="password" v-model="loginForm.imageCode" :type="passwordType" placeholder="验证码"
                  name="imageCode" tabindex="2" auto-complete="on" @keyup.enter.native="handleLogin"/>
      </el-form-item>
      ...
      <div class="el-login-footer">
        <span>Copyright © 2019-2020 zhangds All Rights Reserved.</span>
      </div>
    </el-form>
